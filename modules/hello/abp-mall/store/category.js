import { getCountries, updateCountry, getStateProvinces, updateStateProvince, getCities, updateCity, deleteItem } from '@/api/category'
...
const actions = {
  ...
  getCountries({ commit }) {
   getCountries({}).then(response => {
     commit('setCountry', response[1].data)
     commit('buildTree', 1)
